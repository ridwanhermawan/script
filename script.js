...
function mulaiketik1(){
  ...
  function gantikalimat6(){fthilang();ftganti=2;setTimeout(ftmuncul,300);setTimeout(anim,100);kalimate.innerHTML = "";kalimatf.innerHTML=vketik6;inikuis=3;tombol();}
